...
import pageObjects.jQuery.uploadFileUI.HomePageUI;
...
public class HomePageObject extends BasePage {
	...
	public boolean isFileLoadedByName(String fileName) {
		waitForElementVisble(driver, HomePageUI.FILE_NAME_LOADED, fileName);
	...
	public boolean isFileLinkUpLoadedByName(String fileName) {
		waitForElementVisble(driver, HomePageUI.FILE_NAME_UPLOADED_LINK, fileName);
	...
	public boolean isFileImageUpLoadedByName(String fileName) {
		waitForElementVisble(driver, HomePageUI.FILE_NAME_UPLOADED_IMAGE, fileName);
