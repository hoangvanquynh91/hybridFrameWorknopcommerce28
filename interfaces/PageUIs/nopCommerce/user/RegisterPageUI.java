...
public class RegisterPageUI {
	...
	public static final String PASSWORRD_TEXTBOX = "//input[@id='Password']";
	public static final String CONFIRM_PASSWORRD_TEXTBOX = "//input[@id='ConfirmPassword']";
	...
	public static final String EXITING_EMAIL_MESSAGE = "//div[contains(@class,'validation-summary-errors')]//li";
