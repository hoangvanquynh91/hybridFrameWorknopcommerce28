...
public class RegisterPageUI {
	...
	public static final String PASSWORRD_TEXTBOX = "xpath=//input[@id='Password']";
	public static final String CONFIRM_PASSWORRD_TEXTBOX = "xpath=//input[@id='ConfirmPassword']";
	...
	public static final String EXITING_EMAIL_MESSAGE = "xpath=//div[contains(@class,'validation-summary-errors')]//li";
