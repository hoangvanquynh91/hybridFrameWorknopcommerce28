...
public class HomePageUI {
	...
	public static final String HEARDER_TEXTBOX_BY_LABEL = "xpath=//div[@class = 'qgrd-header-text' and text()='%s']/parent::div/following-sibling::input";
	...
	// Index của cột mà mình cần thao tác enter, click, ...
